import { IsString, IsInt, IsOptional, IsNumber, IsDateString, Min, Max, MaxLength, MinLength, Matches, IsIn } from 'class-validator';
...
export class CreateInboundDto {
  ...
  // UPDATE/DELETE 시에만 필요 (INSERT는 자동 생성)
  @IsString()
  @IsOptional()
  @MinLength(11)
  @MaxLength(11)
  ...
  @IsDateString({}, { message: '올바른 날짜 형식이 아닙니다. (YYYY-MM-DD)' })
  @IsOptional()
  preparation_date?: Date | string; // 조제일자
